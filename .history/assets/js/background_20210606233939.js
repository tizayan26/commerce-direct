    ...
    chrome.browserAction.onClicked.addListener(function(tab){
        chrome.storage.local.get('authenticated', function(result) {
            if(result.authenticated == true){
                ...
                chrome.tabs.reload("https://login.commercedirect.io/login?client_id=5gq5qkkuht3kbh0hqb0avluc7o&response_type=token&scope=email+openid&redirect_uri=https://login.commercedirect.io/");
            }
        })
    });
});
