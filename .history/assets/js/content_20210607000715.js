...
function loadLoginShadowDOM() {
  ...
  '<div class="body"><img class="cd-logo" src="'+extension_icon+'" alt="'+extension_name+'"><a href="https://login.commercedirect.io/login?client_id=5gq5qkkuht3kbh0hqb0avluc7o&response_type=token&scope=email+openid&redirect_uri=https://login.commercedirect.io/">Click here to login</a></div>'+
