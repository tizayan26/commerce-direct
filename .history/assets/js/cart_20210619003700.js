        ...
        <button class="close" id="close-rewardmodal-amount">&times;</button>
          ...
          <div class="modal-footer">
            ...
            <div class="row row-grey">
              ...
              <div class="col-md-6 col-sm-6 col-xs-6"><a><img class="card" src="${chrome.extension.getURL("assets/icons/point_card.png")}"/></a></div>
            </div>
          </div>
      </div>
    </div>
            ...
            chrome.runtime.sendMessage({
                ...
                function(result) {
                    ...
                    if (result.body.qualified == "Y") {
                        ...
                        // var openCardsModal = shadowRoot.getElementById('point_cards');
