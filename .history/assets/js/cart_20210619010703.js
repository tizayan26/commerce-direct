      ...
      <div class="modal-container">
        <button class="close" id="close-rewardmodal-amount">&times;</button>
          ...
          <div class="modal-footer">
            ...
            <div class="row row-grey">
              <div class="col-md-6 col-sm-6 col-xs-6"><img class="cards" style="float:right;" src="${chrome.extension.getURL("assets/icons/cd_card.png")}"/></div>
              <div class="col-md-6 col-sm-6 col-xs-6"><img class="cards" src="${chrome.extension.getURL("assets/icons/point_card.png")}"/></div>
            </div>
