      ...
      <div class="modal-container">
        <button class="close" id="close-rewardmodal-amount">&times;</button>
          ...
          <div class="modal-footer">
            ...
            <div class="row row-grey">
            <div class="col-md-6 col-sm-6 col-xs-6"><div class="cd-card" id="show_cards"><img scr="${chrome.extension.getURL("assets/icons/cd_card.png")}"/ ></div></div>
            <div class="col-md-6 col-sm-6 col-xs-6"><div class="point-card"><img scr="${chrome.extension.getURL("assets/icons/point_card.png")}"/ ></div></div>
            </div>
          </div>
      </div>
    </div>
            ...
            chrome.runtime.sendMessage({
                ...
                function(result) {
                    ...
                    if (result.body.qualified == "Y") {
                        ...
                        var openCardsModal = shadowRoot.getElementById('show_cards');
