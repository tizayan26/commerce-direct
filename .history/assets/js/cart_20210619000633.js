      ...
      <div class="modal-container">
        <button class="close" id="close-rewardmodal-amount">&times;</button>
          ...
          <div class="modal-footer">
            ...
            <div class="row row-grey">
            <div class="col-md-6 col-sm-6 col-xs-6"><a id="show_cards"><img class="card" src="${chrome.extension.getURL("assets/icons/cd_card.png")}"/ ></a></div>
            <div class="col-md-6 col-sm-6 col-xs-6"><a><img class="card" src="${chrome.extension.getURL("assets/icons/point_card.png")}"/ ></div></div>
            </div>
          </div>
      </div>
    </div>
