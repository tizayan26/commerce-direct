...
function loadLoginShadowDOM() {
  ...
  '<div class="body"><img class="cd-logo" src="'+extension_icon+'" alt="'+extension_name+'"><a class="init-link" href="https://login.commercedirect.io/">Click here to login</a></div>'+
...
$(document).ready(function() {
    ...
    uid = getCookie('__opixsee_uid');
    vid = getCookie('__opixsee_vid');
    chrome.storage.local.get(['userid','authenticated'], function(result) {
